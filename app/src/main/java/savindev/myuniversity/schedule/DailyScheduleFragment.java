...
public class DailyScheduleFragment extends DialogFragment
    ...
    private GetScheduleTask gsht = null;
    private String[] data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (true) //Если данные существуют:
...
//            currentID;
        ...
        getActivity().registerReceiver(broadcastReceiver, new IntentFilter("FINISH_UPDATE_DAILY"));
    ...
    public void onRefresh() {
        ...
        gsht = new GetScheduleTask(getActivity(), mSwipeRefreshLayout);
        ...
        gsht.execute(currentSchedule); //Выполняем запрос на обновление нужного расписания
    }
